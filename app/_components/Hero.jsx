...
const Hero = () => {
  return (
    <>
        ...
        <div className="max-w-340 mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
          ...
          <div className="mt-5 max-w-3xl text-center mx-auto">
            <p className="text-lg text-gray-600 dark:text-neutral-400">
              Transform your course creation with our AI-powered app delivering
              engaging, high-quality courses in seconds.
            </p>
          </div>
      ...
      gap-x-3 text-center bg-linear-to-tl from-blue-600
